##' @include abstracts.R QhatModel.homo.normal.linear.R parameters.R QhatModel.homo.normal.linear.AR3.R  QhatModel.homo.normal.linear.fire.R
##' @export
QhatModel.homo.normal.linear.AR3 <- setClass(
  # Set the name for the class
  "QhatModel.homo.normal.linear.AR3.fire",

  package='hydroState',

  contains=c('QhatModel.homo.normal.linear.AR3', 'QhatModel.homo.normal.linear.fire'),
...
setValidity("QhatModel.homo.normal.linear.AR3.fire", validObject)

# Initialise object
#setGeneric(name="initialize",def=function(.Object,input.data){standardGeneric("initialize")})
setMethod("initialize","QhatModel.homo.normal.linear.AR3.fire", function(.Object, input.data, use.truncated.dist=T, transition.graph=matrix(T,2,2),
...
setMethod(f="is.stationary",signature=c("QhatModel.homo.normal.linear.AR3.fire"),definition=function(.Object)
{
...
setMethod(f="getMean",signature=c("QhatModel.homo.normal.linear.AR3.fire","data.frame"),definition=function(.Object, data) {
