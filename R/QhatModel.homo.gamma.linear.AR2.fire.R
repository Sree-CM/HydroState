##' @include abstracts.R QhatModel.homo.gamma.linear.R QhatModel.homo.normal.linear.AR2.fire.R
##' @export
QhatModel.homo.gamma.linear.AR2.fire <- setClass(
  # Set the name for the class
  "QhatModel.homo.gamma.linear.AR2.fire",

  package='hydroState',

  contains=c('QhatModel.homo.gamma.linear', 'QhatModel.homo.normal.linear.AR2.fire'),
...
setValidity("QhatModel.homo.gamma.linear.AR2.fire", validObject)

# Initialise object
#setGeneric(name="initialize",def=function(.Object,input.data){standardGeneric("initialize")})
setMethod("initialize","QhatModel.homo.gamma.linear.AR2.fire", function(.Object,input.data, transition.graph=matrix(T,2,2),state.dependent.mean.a0=T,
...
setMethod(f="getMean",signature=c("QhatModel.homo.gamma.linear.AR2.fire","data.frame"),definition=function(.Object, data)
{
